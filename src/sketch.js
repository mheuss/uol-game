...
class Tree extends Sprite {
  ...
  draw() {
    ...
    stroke(lightBark);
    strokeWeight(15);
    arc(70 + x, 90 + y, 50, 50, PI / 4 + 0.57, PI);
    stroke(darkBark);
    arc(90 + x, 90 + y, 50, 50, PI + 3.3, PI / 4 + 0.57);
...
class Canyon extends Sprite {
  ...
  draw() {
    ...
    fill(blueSky);
    const { x, y } = this;
    quad(40 + x, y, 120 + x, y, 160 + x, 160 + y, x, 160 + y);
    fill(stoneGray);
    triangle(36 + x, 16 + y, x, 160 + y, 36 + x, 160 + y);
    fill(darkerGray);
    triangle(124 + x, 16 + y, 160 + x, 160 + y, 124 + x, 160 + y);
  }
}
